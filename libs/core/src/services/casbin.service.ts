...
import * as casbinAPI from '@weishour/core/plugins/casbin';

/**
 * casbin RBAC API的包装器。根据未来可能的IO操作，所有方法都转换为异步。
 */
@Injectable()
export class CasbinService {
   ...
   * @memberof CasbinService
   */
  getRolesForUser(name: string, domain?: string): Promise<string[]> {
    return casbinAPI.getRolesForUser(this.enforcer, name, domain);
  }
  ...
  getUsersForRole(name: string, domain?: string): Promise<string[]> {
    return casbinAPI.getUsersForRole(this.enforcer, name, domain);
  }
  ...
  hasRoleForUser(
    ...
    return casbinAPI.hasRoleForUser(this.enforcer, name, role, domain);
  }
  ...
  addRoleForUser(
    ...
    return casbinAPI.addRoleForUser(this.enforcer, user, role, domain);
  }
  ...
  deleteRoleForUser(
    ...
    return casbinAPI.deleteRoleForUser(this.enforcer, user, role, domain);
  }
  ...
  deleteRolesForUser(user: string, domain?: string): Promise<boolean> {
    return casbinAPI.deleteRolesForUser(this.enforcer, user, domain);
  }
  ...
  async deleteUser(user: string): Promise<boolean> {
    return casbinAPI.deleteUser(this.enforcer, user);
  }
  ...
  deleteRole(role: string): Promise<boolean> {
    return casbinAPI.deleteRole(this.enforcer, role);
  }
  ...
  deletePermission(...permission: string[]): Promise<boolean> {
    return casbinAPI.deletePermission(this.enforcer, ...permission);
  }
  ...
  addPermissionForUser(
    ...
    return casbinAPI.addPermissionForUser(
      this.enforcer,
      userOrRole,
      ...permission
    );
  ...
  deletePermissionForUser(
    ...
    return casbinAPI.deletePermissionForUser(
      this.enforcer,
      userOrRole,
      ...permission
    );
  ...
  deletePermissionsForUser(userOrRole: string): Promise<boolean> {
    return casbinAPI.deletePermissionsForUser(this.enforcer, userOrRole);
  }
  ...
  getPermissionsForUser(userOrRole: string): Promise<string[][]> {
    return casbinAPI.getPermissionsForUser(this.enforcer, userOrRole);
  }
  ...
  hasPermissionForUser(
    ...
    return casbinAPI.hasPermissionForUser(this.enforcer, user, ...permission);
  }
  ...
  getImplicitRolesForUser(
    ...
    return casbinAPI.getImplicitRolesForUser(this.enforcer, name, ...domain);
  }
  ...
  getImplicitResourcesForUser(
    ...
    return casbinAPI.getImplicitResourcesForUser(this.enforcer, name, ...domain);
  }
  ...
  getImplicitPermissionsForUser(
    ...
    return casbinAPI.getImplicitPermissionsForUser(
      this.enforcer,
      user,
      ...domain
    );
  ...
  getImplicitUsersForPermission(...permission: string[]): Promise<string[]> {
    return casbinAPI.getImplicitUsersForPermission(this.enforcer, ...permission);
  }
  ...
  enforce(...params: any[]): Promise<boolean> {
    return casbinAPI.enforce(this.enforcer, params);
  }
  ...
  enforceWithMatcher(matcher: string, ...params: any[]): Promise<boolean> {
    return casbinAPI.enforceWithMatcher(this.enforcer, matcher, params);
  }
  ...
  enforceEx(...params: any[]): Promise<[boolean, string[]]> {
    return casbinAPI.enforceEx(this.enforcer, params);
  }
  ...
  enforceExWithMatcher(
    ...
    return casbinAPI.enforceExWithMatcher(this.enforcer, matcher, params);
  }
  ...
  batchEnforce(params: any[][]): Promise<boolean[]> {
    return casbinAPI.batchEnforce(this.enforcer, params);
  }
  ...
  getAllSubjects(): Promise<string[]> {
    return casbinAPI.getAllSubjects(this.enforcer);
  }
  /**
  ...
  getAllNamedSubjects(ptype: string): Promise<string[]> {
    return casbinAPI.getAllNamedSubjects(this.enforcer, ptype);
  }
  /**
  ...
  getAllObjects(): Promise<string[]> {
    return casbinAPI.getAllObjects(this.enforcer);
  }
  /**
  ...
  getAllNamedObjects(ptype: string): Promise<string[]> {
    return casbinAPI.getAllNamedObjects(this.enforcer, ptype);
  }
  /**
  ...
  getAllActions(): Promise<string[]> {
    return casbinAPI.getAllActions(this.enforcer);
  }
  /**
  ...
  getAllNamedActions(ptype: string): Promise<string[]> {
    return casbinAPI.getAllNamedActions(this.enforcer, ptype);
  }
  /**
  ...
  getAllRoles(): Promise<string[]> {
    return casbinAPI.getAllRoles(this.enforcer);
  }
  /**
  ...
  getAllNamedRoles(ptype: string): Promise<string[]> {
    return casbinAPI.getAllNamedRoles(this.enforcer, ptype);
  }
  /**
  ...
  getPolicy(): Promise<string[][]> {
    return casbinAPI.getPolicy(this.enforcer);
  }
  /**
  ...
  getFilteredPolicy(
    ...
    return casbinAPI.getFilteredPolicy(
      this.enforcer,
      fieldIndex,
      ...fieldValues
    );
  ...
  getNamedPolicy(ptype: string): Promise<string[][]> {
    return casbinAPI.getNamedPolicy(this.enforcer, ptype);
  }
  /**
  ...
  getFilteredNamedPolicy(
    ...
    return casbinAPI.getFilteredNamedPolicy(
      this.enforcer,
      ptype,
      fieldIndex,
      ...fieldValues
  ...
  getGroupingPolicy(): Promise<string[][]> {
    return casbinAPI.getGroupingPolicy(this.enforcer);
  }
  /**
  ...
  getFilteredGroupingPolicy(
    ...
    return casbinAPI.getFilteredGroupingPolicy(
      this.enforcer,
      fieldIndex,
      ...fieldValues
    );
  ...
  getNamedGroupingPolicy(ptype: string): Promise<string[][]> {
    return casbinAPI.getNamedGroupingPolicy(this.enforcer, ptype);
  }
  /**
  ...
  getFilteredNamedGroupingPolicy(
    ...
    return casbinAPI.getFilteredNamedGroupingPolicy(
      this.enforcer,
      ptype,
      fieldIndex,
      ...fieldValues
  ...
  hasPolicy(...params: string[]): Promise<boolean> {
    return casbinAPI.hasPolicy(this.enforcer, ...params);
  }
  /**
  ...
  hasNamedPolicy(ptype: string, ...params: string[]): Promise<boolean> {
    return casbinAPI.hasNamedPolicy(this.enforcer, ptype, ...params);
  }
  /**
  ...
  addPolicy(...params: string[]): Promise<boolean> {
    return casbinAPI.addPolicy(this.enforcer, ...params);
  }
  ...
  addPolicies(rules: string[][]): Promise<boolean> {
    return casbinAPI.addPolicies(this.enforcer, rules);
  }
  ...
  addNamedPolicy(ptype: string, ...params: string[]): Promise<boolean> {
    return casbinAPI.addNamedPolicy(this.enforcer, ptype, ...params);
  }
  ...
  addNamedPolicies(ptype: string, rules: string[][]): Promise<boolean> {
    return casbinAPI.addNamedPolicies(this.enforcer, ptype, rules);
  }
  ...
  updatePolicy(oldRule: string[], newRule: string[]): Promise<boolean> {
    return casbinAPI.updatePolicy(this.enforcer, oldRule, newRule);
  }
  ...
  updateNamedPolicy(
    ...
    return casbinAPI.updateNamedPolicy(this.enforcer, ptype, oldRule, newRule);
  }
  ...
  removePolicy(...params: string[]): Promise<boolean> {
    return casbinAPI.removePolicy(this.enforcer, ...params);
  }
  /**
  ...
  removePolicies(rules: string[][]): Promise<boolean> {
    return casbinAPI.removePolicies(this.enforcer, rules);
  }
  /**
  ...
  removeFilteredPolicy(
    ...
    return casbinAPI.removeFilteredPolicy(
      this.enforcer,
      fieldIndex,
      ...fieldValues
    );
  ...
  removeNamedPolicy(ptype: string, ...params: string[]): Promise<boolean> {
    return casbinAPI.removeNamedPolicy(this.enforcer, ptype, ...params);
  }
  /**
  ...
  removeNamedPolicies(ptype: string, rules: string[][]): Promise<boolean> {
    return casbinAPI.removeNamedPolicies(this.enforcer, ptype, rules);
  }
  /**
  ...
  removeFilteredNamedPolicy(
    ...
    return casbinAPI.removeFilteredNamedPolicy(
      this.enforcer,
      ptype,
      fieldIndex,
      ...fieldValues
  ...
  hasGroupingPolicy(...params: string[]): Promise<boolean> {
    return casbinAPI.hasGroupingPolicy(this.enforcer, ...params);
  }
  /**
  ...
  hasNamedGroupingPolicy(ptype: string, ...params: string[]): Promise<boolean> {
    return casbinAPI.hasNamedGroupingPolicy(this.enforcer, ptype, ...params);
  }
  /**
  ...
  addGroupingPolicy(...params: string[]): Promise<boolean> {
    return casbinAPI.addGroupingPolicy(this.enforcer, ...params);
  }
  /**
  ...
  addGroupingPolicies(rules: string[][]): Promise<boolean> {
    return casbinAPI.addGroupingPolicies(this.enforcer, rules);
  }
  /**
  ...
  addNamedGroupingPolicy(ptype: string, ...params: string[]): Promise<boolean> {
    return casbinAPI.addNamedGroupingPolicy(this.enforcer, ptype, ...params);
  }
  /**
  ...
  addNamedGroupingPolicies(ptype: string, rules: string[][]): Promise<boolean> {
    return casbinAPI.addNamedGroupingPolicies(this.enforcer, ptype, rules);
  }
  /**
  ...
  removeGroupingPolicy(...params: string[]): Promise<boolean> {
    return casbinAPI.removeGroupingPolicy(this.enforcer, ...params);
  }
  /**
  ...
  removeGroupingPolicies(rules: string[][]): Promise<boolean> {
    return casbinAPI.removeGroupingPolicies(this.enforcer, rules);
  }
  /**
  ...
  removeFilteredGroupingPolicy(
    ...
    return casbinAPI.removeFilteredGroupingPolicy(
      this.enforcer,
      fieldIndex,
      ...fieldValues
    );
  ...
  removeNamedGroupingPolicy(
    ...
    return casbinAPI.removeNamedGroupingPolicy(this.enforcer, ptype, ...params);
  }
  /**
  ...
  removeNamedGroupingPolicies(
    ...
    return casbinAPI.removeNamedGroupingPolicies(this.enforcer, ptype, rules);
  }
  /**
  ...
  removeFilteredNamedGroupingPolicy(
    ...
    return casbinAPI.removeFilteredNamedGroupingPolicy(
      this.enforcer,
      ptype,
      fieldIndex,
      ...fieldValues
  ...
  addFunction(name: string, func: any): Promise<void> {
    return casbinAPI.addFunction(this.enforcer, name, func);
  }
  ...
  loadPolicy(): Promise<void> {
    return casbinAPI.loadPolicy(this.enforcer);
  }
  ...
  updateGroupingPolicy(oldRule: string[], newRule: string[]): Promise<boolean> {
    return casbinAPI.updateGroupingPolicy(this.enforcer, oldRule, newRule);
  }
  ...
  updateNamedGroupingPolicy(
    ...
    return casbinAPI.updateNamedGroupingPolicy(
      this.enforcer,
      ptype,
      oldRule,
      newRule
